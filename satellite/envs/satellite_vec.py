...
from satellite.utils.satellite_util import class_to_dict, sample_random_quaternion_batch
...
class SatelliteVec(VecTask):
    ...
    def apply_torque(self, actions: torch.Tensor) -> None:
        ...
        print (f"[apply_torque] actions[0]: {actions[0] * self._cfg.normalization.max_torque}") 
