...
Start-Process wt -ArgumentList '-w 0 nt --title "Profiler Torch" -p "PowerShell" powershell -NoExit -Command "ssh -tt -J betajump andreaberti@192.168.1.3 ''/home/andreaberti/miniconda3/bin/tensorboard --logdir ./profiler_logs --port 6066''"'
